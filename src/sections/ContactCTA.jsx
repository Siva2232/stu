            ...
            <div className="bg-white p-8 md:p-12 rounded-2xl shadow-lg border border-gray-200">
              ...
              <form className="space-y-5">
                <input
                  ...
                  className="w-full px-5 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-yellow-300 focus:outline-none transition"
                />
                <input
                  type="email"
                ...
                <textarea
                  ...
                  className="w-full px-5 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-yellow-300 focus:outline-none transition resize-none"
                />
                <Button className="w-full py-4 rounded-lg bg-yellow-500 text-gray-900 font-bold hover:bg-yellow-400 transition">
                  Send Message
                </Button>
              </form>
            </div>
          ...
          >
            <div className="space-y-6">
              {[
                ...
                >
                  <div className="p-3 rounded-lg bg-yellow-500 flex items-center justify-center">
